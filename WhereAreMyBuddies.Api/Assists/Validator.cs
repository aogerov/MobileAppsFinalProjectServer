...
namespace WhereAreMyBuddies.Api.Assists
{
    public class Validator
    {
        ...
        public static void ValidateUserRegistration(WhereAreMyBuddiesContext context, UserModel model)
        {
        ...
        public static User ValidateUserLogin(WhereAreMyBuddiesContext context, UserModel model)
        {
            ValidateUsername(model.Username.Trim());
            ValidateAuthCode(model.AuthCode.Trim());
        ...
        public static User ValidateSessionKey(WhereAreMyBuddiesContext context, string sessionKey)
        {
        ...
        public static User ValidateFriendInDb(WhereAreMyBuddiesContext context, int id, string nickname)
        {
        ...
        public static FriendRequest ValidateRequestExistence(
            WhereAreMyBuddiesContext context, User userWhoRespondsToRequest, User friendWhoMadeRequest)
        {
        ...
        private static void ValidateUserInDb(WhereAreMyBuddiesContext context, UserModel model)
        {
        ...
        private static User ValidateLoggedUserInDb(WhereAreMyBuddiesContext context, UserModel model)
        {
